package com.wteam.contorller.alarmRecord;


import com.wteam.framework.common.enums.ResultUtil;
import com.wteam.framework.common.utils.ThreadPoolUtil;
 ...
 */
@RestController
@RequestMapping("staff/alarmrecord")
@Api(tags = "告警记录")
public class AlarmRecordController {
    ...
    public ResultMessage alertsReceived(@RequestBody Map<String,Object>  map) {
        ResultMessage resultMessage = alarmRecordService.alertsReceived(map);
